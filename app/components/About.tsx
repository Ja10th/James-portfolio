...
const About = () => {
  ...
  return (
    <div className="w-full flex justify-between px-8 pt-9">
      <div className="flex flex-col lg:flex-row gap-2 w-full">
        ...
        <div className="flex-2 bg-slate-100 px-8 py-3 rounded-xl">
          ...
          />
          <h1 className="text-[1.3rem] lg:text-[2rem] font-normal-medium flex max-w-4xl md:max-w-5xl pt-5 leading-[130%]">
            James is a front-end engineer and technical writer, passionate about
            creating seamless user experiences and sharing knowledge through
            clear, concise technical content.
          </h1>
          <p className="pt-20 pb-6 text-gray-500">

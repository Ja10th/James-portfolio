  ...
  return (
    <div>
      ...
      <section className='px-8 overflow-hidden'>
            <img src="infooo.gif" alt="Narrify Blog" className='rounded-xl h-[300px] lg:h-[750px] lg:w-full my-10' />
            <img src="infoo.gif" alt="Narrify Blog" className='rounded-xl h-[300px] lg:h-[750px] lg:w-full my-10' />
            <img src="info.gif" alt="Narrify Blog" className='rounded-xl h-[300px] lg:h-[750px] lg:w-full my-10' />
        </section>
      <section>
